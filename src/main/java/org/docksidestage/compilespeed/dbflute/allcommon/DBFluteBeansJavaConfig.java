...
import org.docksidestage.compilespeed.dbflute.allcommon.DBFluteInitializer;
 ...
 */
@Configuration
@ComponentScan(value="org.docksidestage.compile.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new org.docksidestage.compilespeed.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new org.docksidestage.compilespeed.dbflute.allcommon.ImplementedInvokerAssistant();
    }
