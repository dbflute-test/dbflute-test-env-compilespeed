 ...
 */
package org.docksidestage.compilespeed.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "org.docksidestage.compile.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "org.docksidestage.compile.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_FOLLOWING", "org.docksidestage.compile.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("MEMBER_LOGIN", "org.docksidestage.compile.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "org.docksidestage.compile.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_SERVICE", "org.docksidestage.compile.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("MEMBER_STATUS", "org.docksidestage.compile.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "org.docksidestage.compile.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "org.docksidestage.compile.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_CATEGORY", "org.docksidestage.compile.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("PRODUCT_STATUS", "org.docksidestage.compile.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "org.docksidestage.compile.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("PURCHASE_PAYMENT", "org.docksidestage.compile.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        tmpMap.put("REGION", "org.docksidestage.compile.dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("SERVICE_RANK", "org.docksidestage.compile.dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("SUMMARY_PRODUCT", "org.docksidestage.compile.dbflute.bsentity.dbmeta.SummaryProductDbm");
        tmpMap.put("SUMMARY_WITHDRAWAL", "org.docksidestage.compile.dbflute.bsentity.dbmeta.SummaryWithdrawalDbm");
        tmpMap.put("VENDOR_$_DOLLAR", "org.docksidestage.compile.dbflute.bsentity.dbmeta.Vendor$DollarDbm");
        tmpMap.put("VENDOR_CHECK", "org.docksidestage.compile.dbflute.bsentity.dbmeta.VendorCheckDbm");
        tmpMap.put("VENDOR_IDENTITY_ONLY", "org.docksidestage.compile.dbflute.bsentity.dbmeta.VendorIdentityOnlyDbm");
        tmpMap.put("VENDOR_PRIMARY_KEY_ONLY", "org.docksidestage.compile.dbflute.bsentity.dbmeta.VendorPrimaryKeyOnlyDbm");
        tmpMap.put("VENDOR_THE_LONG_AND_WINDING_TABLE_AND_COLUMN", "org.docksidestage.compile.dbflute.bsentity.dbmeta.VendorTheLongAndWindingTableAndColumnDbm");
        tmpMap.put("VENDOR_THE_LONG_AND_WINDING_TABLE_AND_COLUMN_REF", "org.docksidestage.compile.dbflute.bsentity.dbmeta.VendorTheLongAndWindingTableAndColumnRefDbm");
        tmpMap.put("WITHDRAWAL_REASON", "org.docksidestage.compile.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
